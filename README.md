...
> 本仓库由社团成员共同维护。教程内容、制作参与者、贡献者和鸣谢名单会随着每次培训与贡献持续更新。
...
| 期次 / 主题 | 方向 | 计划覆盖内容 | 状态 |
| --- | --- | --- | --- |
| 教程 02：待定 | 开发 / AI | 根据社团培训计划补充 | 规划中 |
| 教程 03：待定 | 开发 / AI | 根据社团培训计划补充 | 规划中 |

新增教程时，请在上表登记期次、方向、主要内容、版本和资料入口；暂未发布的内容统一标记为“规划中”，避免把计划误认为已完成资料。
...
配图与教程正文位于 [`development/git-and-collaboration/`](./development/git-and-collaboration/)。

## 教程更新记录

这里记录教程内容本身的版本变化；仓库结构或 README 的调整不会替代教程版本号。

| 日期 | 教程 / 文件 | 版本 | 更新内容 | 参与者 |
| --- | --- | --- | --- | --- |
| 2026-09-14 | 团队开发与 Git 操作指南 | v1.0.0 | 首次发布，覆盖 Git 与 GitHub 基础、功能分支、Fork、Pull Request、评审、冲突、安全撤销和故障排查 | 待补充 |
| 待更新 | 待定 | - | 后续培训内容、勘误、案例和练习 | 待补充 |

更新教程时，建议同步记录：变更日期、版本号、主要改动、影响章节、验证方式和参与者。

## 教程制作参与者名录

本部分记录参与教程策划、授课、撰写、整理、配图、实验验证和审核的成员。姓名与 GitHub 账号应在本人同意后登记。

| 姓名 / GitHub 账号 | 参与角色 | 负责内容 | 参与教程 |
| --- | --- | --- | --- |
| 待补充 | 课程策划 | 确定培训目标、受众和课程结构 | 教程 01 |
| 待补充 | 主讲 / 撰稿 | 编写或讲解教程主体内容 | 教程 01 |
| 待补充 | 实验验证 | 验证命令、示例和操作结果 | 教程 01 |
| 待补充 | 编辑 / 审核 | 校对内容、链接、格式和可读性 | 教程 01 |
| 待补充 | 配图制作 | 制作或整理教程配图 | 教程 01 |

## 贡献者名录

感谢所有通过 Pull Request、Issue、代码或文档修改、勘误、案例补充、测试反馈和培训建议帮助改进本仓库的成员。

| 贡献者 | 贡献类型 | 贡献内容 | 相关链接 |
| --- | --- | --- | --- |
| 待补充 | 文档 / 代码 / 反馈 | 待补充 | 待补充 |

也可以查看 GitHub 自动生成的[贡献者列表](https://github.com/SCU-PaddlePaddle-Pioneer-Group/paddlepaddle-club-training/graphs/contributors)。名录维护规则：

- 只记录真实发生、可追溯的贡献，不以提交数量作为唯一标准。
- 在本人同意后公开姓名、GitHub 账号或其他身份信息。
- 同一成员可以同时出现在“教程制作参与者”和“贡献者”名录中。
- 每次新增教程或合并重要贡献时，及时补充对应记录。
